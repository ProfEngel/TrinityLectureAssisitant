...
- Windows 11, 64 Bit
- Python 3.11 von python.org, inklusive `Add Python to PATH`
...
2. sichert bei Updates Konfiguration, RAG, Memory und generierte Bilder
3. erstellt eine virtuelle Python-Umgebung
4. installiert gemeinsame und Windows-spezifische Abhängigkeiten
5. erstellt Verknüpfungen auf dem Desktop und im Startmenü
